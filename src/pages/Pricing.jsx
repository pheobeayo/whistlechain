                    ...
                    <div className="lg:w-[90%] md:w-[90%] w-[100%] mx-auto text-center p-8 lg:px-0 md:px-0 ">
                        <div className="flex justify-between flex-col lg:flex-row md:flex-row items-center px-4 lg:px-0 md:px-0">
                            <div className='bg-[#040927] lg:w-[45%] md:w-[45%] w-[100%] border-gradient-to-r  from-[#69EACB] via-[#EACCF8] to-[#6654F1]  border rounded-2xl p-16'>
                                ...
                                <p className='flex gap-2 text-white my-4 text-justify'><img src={mark} alt='' /><span>DAO Validators: Can vote on up to three reports daily</span></p>
                                <p className='flex gap-2 text-white my-4 text-justify'><img src={mark} alt='' /><span>Limited Access: Users need to purchase tokens to 
                                 <br/>   access more reports or to increase their daily voting limit</span></p>
                            ...
                            <div className='bg-[#040927] lg:w-[45%] md:w-[45%] w-[100%] border-gradient-to-r  from-[#69EACB] via-[#EACCF8] to-[#6654F1]  border rounded-2xl p-5'>
                                ...
                                <p className='flex gap-2 text-white my-4 text-justify'><img src={mark} alt='' /><span>Whistleblowers: Unlimited report submissions. Access additional
                                    ...
                                    the DAO who can view and validate their reports</span></p>
                                <p className='flex gap-2 text-white my-4 text-justify'><img src={mark} alt='' /><span>DAO Validators: Unlimited daily voting.</span></p>
                                <p className='flex gap-2 text-white my-4 text-justify'><img src={mark} alt='' /><span>Access to priority voting on critical or high-severity reports</span></p>
                                <p className='flex gap-2 text-white my-4 text-justify'><img src={mark} alt='' /><span>Validators can track and prioritize reports that require urgent investigation</span></p>
                                <p className='flex gap-2 text-white my-4 text-justify'><img src={mark} alt='' /><span>Reward system for DAO</span></p>
                            </div>
                        </div>
