    ...
    return (
        ...
        <main className="bg-[#040927] w-screen h-full">
            <div className='w-[95%] mx-auto p-8'>
                ...
                <h3 className='font-bold mt-4 text-white lg:mt-0 md:mt-0 lg:text-[24px] md:text-[24px] text-[20px] capitalise font-titiliumweb'>All Reports Submitted</h3>
                    <table className="table-fixed border-separate border border-600 rounded-lg  border-spacing-2 w-[70%]">
                        ...
                        <tbody className="text-white p-4">
                            <tr>
                                <td className="border border-white">Unauthorized Financial Transaction and activities</td>
                                <td className="border border-white">Fraud</td>
                                <td className="border border-white">Track Status</td>
                            </tr>
                            <tr>
                                <td className="border border-white">Bribery Allegation in Procurement Contract</td>
                                <td className="border border-white">Bribery and corruption</td>
                                <td className="border border-white">Track Status</td>
                            </tr>
                            <tr>
                                <td className="border border-white">Harassment in the Workplace and beyond</td>
                                <td className="border border-white">Abuse/Harrasment</td>
                                <td className="border border-white">Track Status</td>
                            </tr>
                        </tbody>
                    </table>
