...
const Sidebar = () =>  {
  ...
  return (
    <div className='bg-[#040927] w-[20%] text-[rgb(15,22,15)] p-8 py-12 h-[100vh] hidden lg:flex md:flex flex-col border-x-2 border-white '>
      ...
      <NavLink to="submit-misconduct" className="text-[14px] text-white  flex items-center py-4 mb-4 px-6  hover:text-[#15BFFD]" style={({isActive}) => isActive ? activeStyle : null }><LuMessagesSquare className="mr-4" /> Make a Report</NavLink>
